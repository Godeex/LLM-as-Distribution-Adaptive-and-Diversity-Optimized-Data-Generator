...
def main(args):
    ...
    val_dataset, num_labels,  val_size = load_and_cache_examples(args, tokenizer, mode="val")
    ...
    trainer = Trainer(args, train_dataset=train_dataset, val_dataset=val_dataset,
                      test_dataset=test_dataset, unlabeled=None, num_labels=num_labels, data_size=train_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default="amazon", type=str, help="The name of the task to train")
    parser.add_argument("--data_dir", default="../../dataset/amazon", type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--train_file", default="train/train-amazon.jsonl", type=str, help="Train file")
    parser.add_argument("--val_file", default="val/valid-amazon.jsonl", type=str, help="Validation file")
    parser.add_argument("--test_file", default="test/test-amazon.jsonl", type=str, help="Test file")
    parser.add_argument("--unlabel_file", default="unlabel/unlabel.jsonl", type=str, help="Unlabel file")
